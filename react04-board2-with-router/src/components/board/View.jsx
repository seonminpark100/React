...
function View(props) {
 ...
 /*  console.log("파라미터", params.no); */
  ...
  let vi = props.boardData.reduce((prev, curr)=>{
    ...
    nextNum = readNum +1;
    let isNextNum = props.boardData.reduce((prevm, curr)=>{
      if (curr.no ===isNextNum) {
        prev = true;
      }
      return prev;
    }, false);
    ...
    const goNext= ()=>{
      ...
      console.log('prevNum', isNextNum);
      props.navigate("/view" + isNextNum);
    }
  return(<>
      <header>
      <h2>게시판-읽기</h2>
